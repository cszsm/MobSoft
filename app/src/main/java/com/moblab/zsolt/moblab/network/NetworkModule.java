package com.moblab.zsolt.moblab.network;

import com.moblab.zsolt.moblab.network.coffee.CoffeeApi;
import com.moblab.zsolt.moblab.network.user.UserApi;
import com.moblab.zsolt.moblab.utils.GsonHelper;
...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    public CoffeeApi provideCoffeeApi(Retrofit retrofit) {
